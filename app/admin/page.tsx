    ...
    <div style={{ minHeight:'100vh', background:'var(--black)' }}>
      ...
      <div style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:'1.5rem' }}>
          <span style={{ fontFamily:'Bebas Neue,sans-serif', fontSize:'1.4rem', letterSpacing:'0.15em', color:'var(--rose)' }}>
            nailsbykrsm
          </span>
        ...
        <div style={{ display:'flex', gap:'1rem', alignItems:'center' }}>
          ...
          <button className="btn-ghost" onClick={logout} style={{ fontSize:'0.6rem', padding:'0.5rem 1rem' }}>
            Logout
          </button>
        </div>
      </div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'1rem', marginBottom:'2.5rem' }}>
          {[
            ...
            <div key={s.label} style={{ background:'var(--card)', border:'1px solid var(--border)', padding:'1.2rem 1.5rem' }}>
              ...
              <p style={{ fontFamily:'Bebas Neue,sans-serif', fontSize:'2rem', color:'var(--rose)', letterSpacing:'0.05em' }}>
                {s.value}
              </p>
            </div>
          ))}
          ...
          {(['pending','confirmed','cancelled','calendar'] as Tab[]).map(t => (
            <button key={t} onClick={() => setTab(t)}
              style={{
                ...
                textTransform:'uppercase', padding:'0.75rem 1.2rem', cursor:'pointer',
                    ...
                    <div key={b.id} style={{
                      ...
                      <div>
                        <div style={{ display:'flex', alignItems:'center', gap:'0.75rem', marginBottom:'0.4rem' }}>
                          <span style={{ fontSize:'1.1rem', fontWeight:400 }}>{b.name}</span>
                          <span style={{
                        ...
                        <p style={{ fontFamily:'DM Mono,monospace', fontSize:'0.65rem', color:'var(--muted)' }}>
                          {b.email} · {b.phone}
                        </p>
                        {b.notes && (
                          <p style={{ fontStyle:'italic', fontSize:'0.85rem', color:'var(--muted)', marginTop:'0.35rem' }}>
                            "{b.notes}"
                          </p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <p className="label">
                          {format(parseISO(b.date), 'EEE, MMM d yyyy')} @ {formatTime(b.time)}
                        </p>
                        <p style={{ fontFamily:'Bebas Neue,sans-serif', fontSize:'1.3rem', color:'var(--rose)', marginTop:'0.25rem' }}>
                          ${b.price}
                        </p>
                      </div>
                        ...
                        {b.status !== 'confirmed' && (
                          <button
                            ...
                            style={{
                              ...
                              background:'rgba(168,212,168,0.1)', border:'1px solid rgba(168,212,168,0.4)',
                              color:'#a8d4a8', textTransform:'uppercase', transition:'all 0.2s',
                        ...
                        {b.status !== 'cancelled' && (
                          <button
                            ...
                            style={{
                              fontFamily:'DM Mono,monospace', fontSize:'0.6rem', letterSpacing:'0.15em',
                              padding:'0.5rem 1rem', cursor:'pointer',
                              background:'rgba(212,160,160,0.1)', border:'1px solid rgba(212,160,160,0.3)',
                              color:'#d4a0a0', textTransform:'uppercase', transition:'all 0.2s',
                              opacity: updating===b.id ? 0.5 : 1
                            }}
                          >
                            ✕ Cancel
                        ...
                        {b.status !== 'pending' && (
                          <button
                            ...
                            style={{
                              ...
                              color:'var(--muted)', textTransform:'uppercase', transition:'all 0.2s'
                            }}
                          >
                            ↺ Pending
                          </button>
        ...
        {tab === 'calendar' && (
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'2rem' }}>
            ...
            <div style={{ background:'var(--card)', border:'1px solid var(--border)', padding:'1.5rem' }}>
              ...
              <p style={{ fontSize:'0.9rem', color:'var(--muted)', fontStyle:'italic', marginBottom:'1.5rem' }}>
                Use this to mark days off or reserve times for yourself.
              </p>
              <div style={{ display:'flex', flexDirection:'column', gap:'0.8rem' }}>
                <input
                  ...
                  style={{
                    padding:'0.75rem', background:'var(--black)', border:'1px solid var(--border)',
                    color:'var(--text)', fontFamily:'DM Mono,monospace', fontSize:'0.75rem', outline:'none'
                  }}
                />
                <select
                  value={blockTime}
                  ...
                  style={{
                    padding:'0.75rem', background:'var(--black)', border:'1px solid var(--border)',
                    color: blockTime ? 'var(--text)' : 'var(--muted)',
                    fontFamily:'DM Mono,monospace', fontSize:'0.75rem', outline:'none'
                  }}
                >
            ...
            <div style={{ background:'var(--card)', border:'1px solid var(--border)', padding:'1.5rem' }}>
              ...
              {blockedSlots.length === 0 ? (
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:'0.5rem' }}>
                  {blockedSlots.map(b => (
                    <div key={`${b.date}-${b.time}`} style={{
                      display:'flex', justifyContent:'space-between', alignItems:'center',
                      padding:'0.6rem 0', borderBottom:'1px solid rgba(200,150,180,0.05)'
                    }}>
                      ...
                      <button
                        onClick={() => unblockSlot(b.date, b.time)}
                        style={{
                          fontFamily:'DM Mono,monospace', fontSize:'0.55rem', letterSpacing:'0.1em',
                          padding:'0.3rem 0.7rem', cursor:'pointer', background:'transparent',
                          border:'1px solid rgba(212,160,160,0.3)', color:'#d4a0a0', textTransform:'uppercase'
                        }}
                      >
                        unblock
                      </button>
